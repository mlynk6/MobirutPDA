...
public class entPedidoDet {
    private int n_codpedido=0,n_linea=0,n_codcia=0,n_codpro=0;
    ...
    private double n_pordsctosisventa=0,n_pordsctomontoad=0,n_pordsctocat=0,n_pordsctomonto=0;
    private double n_impdessisventa=0,n_impdescategoria=0,n_impdessisventaad=0,n_impdesitem=0;
    private double n_impdesmonto=0,n_stockvend=0,n_preciovend=0,n_pordsctocatmod=0,n_tipocambio=0;
    private int n_partirpedido=0;
    private Date d_fechapcp;
    private String c_flagpase="N",c_flagsinproystock="N";
    ...
    public double getPorDsctoCatMod() {
        return n_pordsctocatmod;
    }

    public void setPorDsctoCatMod(double n_pordsctocatmod) {
        this.n_pordsctocatmod = n_pordsctocatmod;
    }
    ...
    public String getFlagSinProyStock() {
        return c_flagsinproystock;
    }

    public void setFlagSinProyStock(String c_flagsinproystock) {
        this.c_flagsinproystock = c_flagsinproystock;
    }
}
