...
public class entPedido {
    private int n_codpedido=0,n_codestadoped=0,n_codcliente=0,n_coddirecc=0,n_cantdias=0;
    private Date d_fecregistro,d_fecmodif;
    private int n_flgparc=0,n_codsisventa=0,n_tiempopedido=0,n_codmoneda=0,n_secuencia=0;
    private double n_montobruto=0,n_montodsctototal=0,n_montoigv=0;
    private int n_codcia=0,n_codcategoria=0,n_coddscto=0,n_idparametros=0,n_codobserv=0;
    private String v_codvendedor="",v_codlinea="",v_codvendcia="";
    private double n_pordsctocat=0,n_pordsctosisventa=0,n_pordsctomonto=0,n_pordsctomontoad=0;
    ...
    private int n_codcotiza=0,n_codvisita=0,n_codtranspor=0,n_letras=0,n_operaciones=0;
    private String c_recalcular="N",c_pedidolys="N",c_partirpedido="N",c_tipopartir="A";
    private String c_tipocuota="F",c_obspase="",c_obsventa="",c_retomado="N",c_estadoenv="";
    private String c_numeroorden="",c_obspedido="",c_cambiomonedaret="",c_simulado="";
    private int n_cotizacion=0,n_codmonedaant=0;
    private double n_tipocambio=0,n_tipocambiohoy=0;
    private Date d_fechatcambio;
    private String c_flagsolobitacora="N";
    ...
    public int getTiempoPedido() {
        return n_tiempopedido;
    }

    public void setTiempoPedido(int n_tiempopedido) {
        this.n_tiempopedido = n_tiempopedido;
    }
    ...
    public String getPedidoLys() {
        return c_pedidolys;
    }

    public void setPedidoLys(String c_pedidolys) {
        this.c_pedidolys = c_pedidolys;
    }
    ...
    public String getRetomado() {
        return c_retomado;
    }

    public void setRetomado(String c_retomado) {
        this.c_retomado = c_retomado;
    }
    ...
    public void setEstadoEnv(String c_estadoenv) {
        this.c_estadoenv = c_estadoenv;
    }
    ...
    public String getFlagSoloBitacora() {
        return c_flagsolobitacora;
    }

    public void setFlagSoloBitacora(String c_flagsolobitacora) {
        this.c_flagsolobitacora = c_flagsolobitacora;
    }
}
